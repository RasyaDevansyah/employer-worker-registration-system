...
import com.cbozan.view.constants.UIConstants;
...
public class WorkerPaymentPanel extends JPanel implements Observer, FocusListener, ActionListener, Serializable{
	...
	public WorkerPaymentPanel() {
		...
		imageLabel.setBounds(UIConstants.LEFT_LABEL_X, 40, 128, 130);
		add(imageLabel);
		...
		workerLabel.setBounds(UIConstants.LEFT_LABEL_X, UIConstants.LEFT_LABEL_Y, UIConstants.LEFT_LABEL_WIDTH, UIConstants.LABEL_HEIGHT);
		add(workerLabel);

		workerTextField = new JTextField("Please select worker");
		workerTextField.setEditable(false);
		workerTextField.setBounds(workerLabel.getX(), workerLabel.getY() + UIConstants.LABEL_HEIGHT + UIConstants.SMALL_HEIGHT_SPACE, UIConstants.LEFT_LABEL_WIDTH, UIConstants.LABEL_HEIGHT);
		add(workerTextField);


		jobLabel = new JLabel("Job selection");
		jobLabel.setBounds(workerTextField.getX(), workerTextField.getY() + UIConstants.LABEL_HEIGHT + UIConstants.MEDIUM_HEIGHT_SPACE, UIConstants.LEFT_LABEL_WIDTH, UIConstants.LABEL_HEIGHT);
		add(jobLabel);

		jobTextField = new JTextField("Please select job");
		jobTextField.setEditable(false);
		jobTextField.setBounds(jobLabel.getX(), jobLabel.getY() + UIConstants.LABEL_HEIGHT + UIConstants.SMALL_HEIGHT_SPACE, UIConstants.LEFT_LABEL_WIDTH, UIConstants.LABEL_HEIGHT);
		add(jobTextField);


		paytypeLabel = new JLabel("Paymnet method");
		paytypeLabel.setBounds(jobTextField.getX(), jobTextField.getY() + UIConstants.LABEL_HEIGHT + UIConstants.MEDIUM_HEIGHT_SPACE, UIConstants.LEFT_LABEL_WIDTH, UIConstants.LABEL_HEIGHT);
		add(paytypeLabel);

		paytypeComboBox = new JComboBox<>();
		paytypeComboBox.setBounds(paytypeLabel.getX(), paytypeLabel.getY() + UIConstants.LABEL_HEIGHT + UIConstants.SMALL_HEIGHT_SPACE, UIConstants.LEFT_LABEL_WIDTH, UIConstants.LABEL_HEIGHT);
		add(paytypeComboBox);


		amountLabel = new JLabel("Amount of payment");
		amountLabel.setBounds(paytypeComboBox.getX(), paytypeComboBox.getY() + UIConstants.LABEL_HEIGHT + UIConstants.MEDIUM_HEIGHT_SPACE, UIConstants.LEFT_LABEL_WIDTH, UIConstants.LABEL_HEIGHT);
		add(amountLabel);

		amountTextField= new JTextField();
		amountTextField.setBounds(amountLabel.getX(), amountLabel.getY() + UIConstants.LABEL_HEIGHT + UIConstants.SMALL_HEIGHT_SPACE, UIConstants.LEFT_LABEL_WIDTH, UIConstants.LABEL_HEIGHT);
		...
		workerSearchImageLabel.setBounds(UIConstants.RIGHT_LABEL_X - 32 + (UIConstants.RIGHT_LABEL_WIDTH - 30) / 4, UIConstants.RIGHT_LABEL_Y, 64, 64);
		add(workerSearchImageLabel);



		workerSearchBox = new SearchBox(WorkerDAO.getInstance().list(), new Dimension((UIConstants.RIGHT_LABEL_WIDTH - 30) / 2, UIConstants.LABEL_HEIGHT)) {
			private static final long serialVersionUID = 1L;
		...
		workerSearchBox.setBounds(UIConstants.RIGHT_LABEL_X, UIConstants.RIGHT_LABEL_Y + 64 + 10, (UIConstants.RIGHT_LABEL_WIDTH - 30) / 2, UIConstants.LABEL_HEIGHT);
		add(workerSearchBox);

		workerSearchBox.getPanel().setBounds(workerSearchBox.getX(), workerSearchBox.getY() + UIConstants.LABEL_HEIGHT, (UIConstants.RIGHT_LABEL_WIDTH - 30) / 2, 0);
		...
		jobSearchImageLabel.setBounds((UIConstants.RIGHT_LABEL_X + workerSearchBox.getWidth() + 30) - 32 + (UIConstants.RIGHT_LABEL_WIDTH - 30) / 4, UIConstants.RIGHT_LABEL_Y, 64, 64);
		add(jobSearchImageLabel);


		jobSearchBox = new SearchBox(JobDAO.getInstance().list(), new Dimension((UIConstants.RIGHT_LABEL_WIDTH - 30) / 2, UIConstants.LABEL_HEIGHT)) {
			private static final long serialVersionUID = 1L;
		...
		jobSearchBox.setBounds(UIConstants.RIGHT_LABEL_X + workerSearchBox.getWidth() + 30, jobSearchImageLabel.getY() + 64 + 10, (UIConstants.RIGHT_LABEL_WIDTH - 30) / 2, UIConstants.LABEL_HEIGHT);
		add(jobSearchBox);

		jobSearchBox.getPanel().setBounds(jobSearchBox.getX(), jobSearchBox.getY() + UIConstants.LABEL_HEIGHT, (UIConstants.RIGHT_LABEL_WIDTH - 30) / 2, 0);
		...
		checkBoxLabel.setBounds(jobSearchCheckBox.getX() + 25, jobSearchCheckBox.getY(), (UIConstants.RIGHT_LABEL_WIDTH - 30) / 2 - 18, 20);
		...
		lastPaymentsScroll.setBounds(UIConstants.RIGHT_LABEL_X, workerTextField.getY(), UIConstants.RIGHT_LABEL_WIDTH, 260);
